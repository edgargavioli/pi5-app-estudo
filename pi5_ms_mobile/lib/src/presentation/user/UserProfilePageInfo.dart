...
class _UserProfilePageInfoState extends State<UserProfilePageInfo> {
  final TextEditingController nomeController = TextEditingController(text: 'Edgar Gavioli');
  final TextEditingController usuarioController = TextEditingController(text: '@edgar_gavioli');
            ...
            children: [
              ...
              Align(
                ...
                child: GestureDetector(
                  ...
                  child: const Text(
                    'Alterar senha',
                    style: TextStyle(color: Color(0xFF3B5B82), fontWeight: FontWeight.w500, decoration: TextDecoration.underline),
                  ),
                ),
              ),
            ],
                  ...
                  children: [
                    ...
                    InputWidget(
                      ...
                      suffixIcon: IconButton(
                        ...
                        onPressed: () => setState(() => obscureConfirmar = !obscureConfirmar),
                      ),
                    ),
                  ],
                ),
