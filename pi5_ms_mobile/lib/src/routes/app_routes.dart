...
class AppRoutes {
  ...
  static Map<String, WidgetBuilder> get routes {
    return {
      initial: (context) => _getInitialPage(context),
      ...
      materias: (context) => _protectedRoute(context, _getMateriaListagemPage(context)),
      materiasAdd: (context) => _protectedRoute(context, _getMateriaAdicionarPage(context)),
      provas: (context) => _protectedRoute(context, const ProvasListagemPage()),
      provasAdd: (context) => _protectedRoute(context, const AdicionarProvaPage()),
      provasEditar: (context) => _protectedRoute(context, _getProvaEditarPage(context)),
      cronograma: (context) => _protectedRoute(context, const CronogramaPage()),
      estudos: (context) => _protectedRoute(context, const EstudosPage()),
      historico: (context) => _protectedRoute(context, const HistoricoPage()),
  ...
  static Widget _getInitialPage(BuildContext context) {
    // Verificar se há token salvo
    if (_authService.isLoggedIn) {
      return const ScaffoldWidget(); // Home com navegação
    } else {
      return LoginPage(onLogin: () => _handleLogin(context));
    }
  }
